...
public sealed class HomepageProductCardConsistencyTests
{
    ...
    public void Home_page_reuses_the_catalogue_product_card()
    {
        ...
        Assert.Contains("class=\"hp-products-more\" href=\"/shop\"", home, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain(".hp-product-grid .st-pcard:nth-child(n+5)", homeCss, StringComparison.Ordinal);
        Assert.Contains(".hp-products-more", homeCss, StringComparison.Ordinal);
        Assert.Contains(".hp-category { min-height: 124px;", homeCss, StringComparison.Ordinal);
