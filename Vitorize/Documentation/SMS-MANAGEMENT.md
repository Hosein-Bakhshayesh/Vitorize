...
سامانه فقط دو قرارداد آسانک دارد:
...
شناسه‌های واقعی آسانک هاردکد نشده‌اند. دو ورودی اصلی `Sms.OtpTemplateId` و `Sms.NotificationTemplateId` کلیدهای قدیمی را برای سازگاری همگام می‌کنند.
