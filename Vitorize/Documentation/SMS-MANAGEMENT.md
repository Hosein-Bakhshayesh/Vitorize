...
سامانه هیچ قالب آسانکی استفاده نمی‌کند. OTPهای Login، Mobile Verification و Forgot Password و تمام اطلاع‌رسانی‌های عملیاتی متن آزادِ متعلق به برنامه‌اند و با شماره مبدأ آسانک ارسال می‌شوند.
...
- سلامت اتصال، اعتبار، خطوط و وضعیت Outbox
...
3. مقداردهی اطلاعات اتصال آسانک از تنظیمات مدیر
...
هیچ شناسه قالبی در کد یا تنظیمات فعال نیست؛ تنظیمات تاریخی قالب OTP و اطلاع‌رسانی با migration حذف می‌شوند.
