...
INSERT INTO dbo.[Settings] ([Id], [Key], [Value], [GroupName], [ValueType], [Description], [UpdatedAt]) VALUES
  ...
  ('40453621-040d-4b20-9e6d-3d7bf1eef55d', N'StorefrontDefaultProductSort', N'AvailabilityFirst', N'General', N'sortmode', N'ترتیب پیش‌فرض نمایش کالاها برای مشتریان در فروشگاه', CONVERT(datetime2, '2026-08-24T07:44:22.4579635', 126)),
  ...
  ('a25c8e26-3962-4eec-8b7a-670afea2d440', N'StorefrontPersianFont', N'Peyda', N'Typography', N'font', N'Default Persian storefront font.', CONVERT(datetime2, '2026-08-24T07:44:22.4579635', 126)),
...
----------------------------------------------------------------------------*/
PRINT N'Recording deployment history (30 script(s))...';
GO
INSERT INTO dbo.DatabaseScriptHistory (ScriptName, ScriptVersion, ScriptHash, AppliedAt, AppliedBy, Environment, Success, Notes) VALUES
  ...
  (N'V0025__peyda_default_and_sortmode_setting_type.sql', N'V0025', N'ad21b18d3918da4ab56221e1b00b1fd4c455de9f58cc50d1adc28513a713d5c6', SYSUTCDATETIME(), SUSER_SNAME(), N'Development', 1, N'Canonical deployment chain');
GO
